...
HD_PWD='C:/Users/oousterm/Documents/GitHub/CPE-233/Lab_05/Lab_05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_5_Main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_5_Main.tcl -notrace
