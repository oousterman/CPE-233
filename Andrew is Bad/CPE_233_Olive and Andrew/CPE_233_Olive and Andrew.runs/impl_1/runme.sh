...
HD_PWD='C:/Users/oousterm/Documents/GitHub/CPE-233/Andrew is Bad/CPE_233_Olive and Andrew/CPE_233_Olive and Andrew.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp1_Main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Exp1_Main.tcl -notrace
