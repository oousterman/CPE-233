...
HD_PWD='C:/Users/oousterm/Documents/GitHub/CPE-233/Andrew is Bad/CPE_233_Olive and Andrew/CPE_233_Olive and Andrew.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp1_Main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exp1_Main.tcl
